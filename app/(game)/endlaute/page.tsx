  ...
  return (
    <div>
      ...
      <div className="font-nunito font-black text-xl text-blue-900 bg-gradient-to-r from-blue-50
        ...
        🔚 Endlaute – Welcher Buchstabe kommt am Ende?
      </div>
      <p className="text-center text-blue-400 text-sm mb-4">Schreibe den letzten Buchstaben!</p>

      {isFetching ? (
        <div className="text-center text-blue-400 py-12 text-lg">Lade...</div>
      ) : (
        <EndlauteGame questions={questions} onScore={addScore} onComplete={handleComplete} />
      )}
