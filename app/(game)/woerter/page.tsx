...
import WoerterGame from '@/components/game/WoerterGame';
  ...
  return (
    <div>
      ...
      <div className="font-nunito font-black text-xl text-blue-900 bg-gradient-to-r from-blue-50
        ...
        📝 Wörter – Sortiere die Buchstaben!
      </div>
      <p className="text-center text-blue-400 text-sm mb-4">Klicke auf die Buchstaben in der richtigen Reihenfolge!</p>

      {isFetching ? (
        <div className="text-center text-blue-400 py-12 text-lg">Lade...</div>
      ) : (
        <WoerterGame questions={questions} onScore={addScore} onComplete={handleComplete} />
      )}
