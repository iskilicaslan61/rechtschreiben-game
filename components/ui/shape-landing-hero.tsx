...
function ElegantShape({
  ...
  return (
    ...
    >
      <motion.div
        animate={{ y: [0, 15, 0] }}
        transition={{ duration: 12, repeat: Number.POSITIVE_INFINITY, ease: "easeInOut" as const }}
        style={{ width, height }}
        className="relative"
      >
        <div
...
function HeroGeometric({
  ...
  title2 = "macht Spaß!",
  subtitle = "Ein interaktives Lernspiel für Kinder – Buchstaben, Silben und Wörter spielerisch üben.",
  ctaPrimary,
  ctaSecondary,
}: {
  badge?: string;
  ...
  return (
    <div className="relative min-h-screen w-full flex items-center justify-center overflow-hidden bg-[#020818]">
      {/* Arka plan parıltısı */}
      <div className="absolute inset-0 bg-gradient-to-br from-blue-600/[0.07] via-transparent to-indigo-500/[0.07] blur-3xl" />

      {/* Yüzen şekiller — mavi tema */}
      ...
      <div className="relative z-10 container mx-auto px-4 md:px-6">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <motion.div
            ...
            initial="hidden"
            animate="visible"
            className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-white/[0.04] border border-white/[0.10] mb-8 md:mb-12"
          >
      ...
      {/* Alt/üst karartma */}
      <div className="absolute inset-0 bg-gradient-to-t from-[#020818] via-transparent to-[#020818]/80 pointer-events-none" />
    </div>
  );
}
