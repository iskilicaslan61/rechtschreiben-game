...
const Icon = ({
  ...
  return (
    ...
    >
      <motion.div
        className="flex items-center justify-center w-16 h-16 md:w-20 md:h-20 p-3 rounded-3xl shadow-xl bg-white/90 backdrop-blur-md border border-blue-100"
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 text-center px-4">
        ...
        <p className="mt-6 max-w-xl mx-auto text-lg text-blue-600 font-medium">
          {subtitle}
        </p>
        <div className="mt-10">
          <Button asChild size="lg"
            className="px-8 py-6 text-base font-semibold bg-gradient-to-b from-blue-500 to-blue-700 hover:from-blue-600 hover:to-blue-800 text-white border-0">
